...
function startQuiz() {
    ...
    if (category === "random") {
        // Combine all questions from trivia, math, and football
        const allQuestions = [
            ...questions.trivia,
            ...questions.math,
            ...questions.football
        ...
        // Select from the chosen category
    ...
    currentIndex = 0;
    selectedQuestions.forEach(q => q.userAnswer = null); // Clear previous answers
    displayQuestion();
